...
class TestInterpolationValidation:
    ...
    def test_validation_passes_with_matching_data(self, mock_context, matching_data):
    ...
    def test_validation_fails_with_mismatched_data(
        self, mock_context, mismatched_data
    ):
    ...
    def test_validation_handles_empty_data(self, mock_context):
    ...
    def test_validation_handles_missing_meter(self, mock_context, matching_data):
...
class TestInterpolationQualityReport:
    ...
    def test_quality_report_generation(
        self, mock_context, mock_config, sample_data
    ):
    ...
    def test_quality_report_handles_empty_data(self, mock_context, mock_config):
    ...
    def test_quality_report_multiple_meters(self, mock_context, mock_config):
        ...
        meter_1_gaps = report[report["meter_id"] == "meter_1"]["largest_gap_days"].iloc[0]
        meter_2_gaps = report[report["meter_id"] == "meter_2"]["largest_gap_days"].iloc[0]
        meter_3_gaps = report[report["meter_id"] == "meter_3"]["largest_gap_days"].iloc[0]
