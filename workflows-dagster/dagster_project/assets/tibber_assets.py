    ...
    with influxdb.get_client() as client:
        ...
        for data_point in consumption_data:
            ...
            point = (
                ...
                .tag("domain", "sensor")
                .field("consumption", float(data_point.get("consumption", 0)))
                .field("cost", float(data_point.get("cost", 0)))
                .field("unit_price", float(data_point.get("unitPrice", 0)))
                .field("unit_price_vat", float(data_point.get("unitPriceVAT", 0)))
