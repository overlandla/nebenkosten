...
class TestMeterDiscoveryAsset:
    ...
    def test_discovers_meters(
        ...
        mock_client.discover_available_meters.return_value = ["strom_total", "gas_total", "wasser"]
...
class TestFetchMeterDataAsset:
    ...
    def test_fetches_data_for_all_meters(
        ...
        result = fetch_meter_data(context, meter_list, mock_influxdb_resource, mock_config_resource)
...
class TestMasterMeterSeriesAsset:
    ...
    def test_applies_unit_conversion(self, mock_config_resource):
        ...
        result = master_meter_series(context, daily_data, monthly_data, mock_config_resource)
...
class TestConsumptionDataAsset:
    ...
    def test_calculates_consumption(self, mock_calc_class, mock_config_resource):
        ...
        result = consumption_data(context, daily_series, master_series, mock_config_resource)
    ...
    def test_combines_physical_and_master_meters(self, mock_calc_class, mock_config_resource):
        ...
        mock_calc = MagicMock()
        mock_calc.calculate_consumption_from_readings.return_value = generate_consumption_data(days=9)
        mock_calc_class.return_value = mock_calc
...
class TestVirtualMeterDataAsset:
    ...
    def test_calculates_virtual_meters(self, mock_config_resource):
        ...
        consumption = {
            ...
            "gastherme_gesamt": generate_consumption_data(days=31, base_consumption=15.0)
        }
    ...
    def test_clips_negative_values(self, mock_config_resource):
        ...
        consumption = {
            ...
            "gastherme_gesamt": generate_consumption_data(days=10, base_consumption=10.0)
        }
...
class TestAnomalyDetectionAsset:
    ...
    def test_no_anomalies_for_consistent_data(self):
        ...
        consumption = {"meter1": generate_consumption_data(days=31, base_consumption=10.0, variation=0.5)}
        virtual_consumption = {}
    ...
    def test_combines_consumption_and_virtual(self):
        ...
        virtual_consumption = {"virtual1": generate_anomaly_data(days=31, anomaly_days=[20])}
